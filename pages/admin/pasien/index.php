...
<?php
    ...
    ?>
        ...
        <div class="row mt-3">
            ...
            <input type="text" class="form-control" required name="no_rm" id="no_rm" readonly placeholder="no_rm" value="<?php echo $no_rm ?>">
        </div>
...
<div class="card">
  ...
  <div class="card-body">
    ...
    if (isset($_POST['simpan'])) {
        if (isset($_POST['id'])) {
            // Query Update Data Pasien (Tidak mengubah no_rm)
            ...
            // Query Insert Data Pasien Baru (Menyertakan no_rm)
