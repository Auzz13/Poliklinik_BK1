...
<form class="form col" method="POST" action="" name="myForm">
  ...
  <div class="row mt-3">
    ...
    <input type="text" class="form-control" name="keterangan" id="keterangan" placeholder="Keterangan" value="<?php echo $keterangan ?>" required>
  </div>
...
<div class="card">
  ...
  <div class="card-body">
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a class="btn btn-success rounded-pill px-3" href="index.php?id=<?php echo $data['id'] ?>">Edit</a>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['simpan'])) {
      if (isset($_POST['nama_poli'], $_POST['keterangan']) && !empty($_POST['nama_poli']) && !empty($_POST['keterangan'])) {
        if (isset($_POST['id'])) {
          try {
